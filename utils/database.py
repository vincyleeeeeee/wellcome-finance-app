...
def save_project(project_data: dict) -> int:
    ...
    result = sb.table("projects").insert({
        ...
        "venue": project_data.get("venue", ""),
        "execution_period": project_data.get("execution_period", ""),
        "shooting_date": project_data.get("shooting_date", ""),
        "total_posts": project_data.get("total_posts", ""),
